...
class RealTimeApi(object):
    ...
    def create_notification(self, **kwargs):  # noqa: E501
        ...
        Send a notification to one or multiple users. You can identify users by their email address or by an external_id.  You don't have to import your users into MagicBell. If a user does not exist we'll create it automatically.  The new notification will be shown in the notification inbox of each recipient in real-time. It will also be delivered to each recipient through all channels your have enabled for your MagicBell project.  # noqa: E501
        ...
        :param wrapped_notification:
        :type wrapped_notification: WrappedNotification
        ...
        :rtype: CreateNotification201Response
        """
    ...
    def create_notification_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateNotification201Response, status_code(int), headers(HTTPHeaderDict))
        """

        local_var_params = locals()

        all_params = ["wrapped_notification"]
        all_params.extend(
            [
                "async_req",
        ...
        body_params = None
        if "wrapped_notification" in local_var_params:
            body_params = local_var_params["wrapped_notification"]
        # HTTP header `Accept`
        ...
        response_types_map = {
            201: "CreateNotification201Response",
            422: "CreateNotification422Response",
        }
